#!/bin/sh
# Adapted from https://github.com/signalwire/freeswitch/blob/v1.10.9/docker/base_image/make_min_archive.sh
# Creates a root archive with the build prefix + its shared library dependencies.
